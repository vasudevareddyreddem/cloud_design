                                    ...
                                    <table id="saveStage" class="display" style="width:100%;">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>xxxxxx500</td>
                                                <td>85xxxxxxx</td>
                                                <td>xxxx ,Hyderabad.</td>
												<td><button class="btn btn-xs bg-success no-margin" type="button">Paid</button></td>
												<td>Online</td>
                                                <td class="valigntop">
                                                    <div class="btn-group">
											...
											<tr>
                                                ...
                                                <td>85xxxxxxx</td>
                                                <td>xxxx ,Hyderabad.</td>
												<td><button class="btn btn-xs bg-warning no-margin" type="button">Pending</button></td>
												<td>Online</td>
                                                <td class="valigntop">
                                                    <div class="btn-group">
                                                        <button class="btn btn-xs deepPink-bgcolor dropdown-toggle no-margin" type="button" data-toggle="dropdown" aria-expanded="false"> Actions
